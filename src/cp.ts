...
export const cordova = {
  ...
  exec: function (
    ...
    //    if (service == "FastCanvas") {
    //      _gfx.Exec(callbackId, service, action, argsJson);
    //    } else {
    _ExecCP(callbackId, service, action, argsJson);
    //    }
  },
   ...
   */
  callbackSuccess: function (callbackId, args): void {
    try {
   ...
   */
  callbackError: function (callbackId, args): void {
