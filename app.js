...
{				
	...
	/*#app*/ this.SetMargins  = function( left,top,right,bottom,mode ) { prompt( "#", "App.SetMargins(\f"+left+"\f"+top+"\f"+right+"\f"+bottom+"\f"+mode ); }
	/*#app*/ this.SetTextSize  = function( size,mode ) { prompt( "#", "App.SetTextSize(\f"+size+"\f"+mode ); }
