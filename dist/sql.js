...
const txLocks = {};
const nextTick = window.setImmediate ||
    function (fun) {
...
class SQLitePluginTransaction {
    ...
    run() {
        ...
        // eslint-disable-next-line
        const tx = this;
        const handlerFor = function (index, didSucceed) {
...
class SQLitePlugin {
    ...
    executeSql(statement, params, success, error) {
        ...
        // eslint-disable-next-line
        const mysuccess = function (t, r) {
            if (success) {
                return success(r);
            }
        };
        // eslint-disable-next-line
        const myerror = function (t, e) {
            if (error) {
                return error(e);
            }
        };
        const myfn = function (tx) {
